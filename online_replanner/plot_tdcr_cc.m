...
%     plot(T1_cc(:,13),T1_cc(:,14),'Color',[0.005*i 1-0.005*i 1-0.005*i],'LineWidth',radius1);
    scatter(T1_cc(end,13),T1_cc(end,14),'MarkerEdgeColor',[0 0 0], 'MarkerFaceColor',[0 0 0], 'LineWidth',1)
    scatter(T2_cc(end,13),T2_cc(end,14),'MarkerEdgeColor',[0 0 0], 'MarkerFaceColor',[0 0 0], 'LineWidth',1)
    scatter(T3_cc(end,13),T3_cc(end,14),'MarkerEdgeColor',[0 0 0], 'MarkerFaceColor',[0 0 0], 'LineWidth',1)
